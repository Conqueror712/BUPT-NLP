...
class SGNS:
    def __init__(self, train_path: str = 'data/lmtraining.txt', window_size=2, negative_sample_num=4, embedding_size=100, device='cuda', has_train=False):
        """
    ...
    def train(self, epoch_num, save_path='model/SGNS.pth'):
        ...
        self.embeddings = self.model.embedding.to('cuda')
...
def main():
    get_sgns_ans(has_train=False, test_path='data/wordsim353_agreed.txt', epoch_num=5, model_path='model/SGNS.pth')
